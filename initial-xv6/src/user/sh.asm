...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d058593          	addi	a1,a1,720 # 1330 <malloc+0xfc>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	29e50513          	addi	a0,a0,670 # 1338 <malloc+0x104>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37270713          	addi	a4,a4,882 # 1438 <malloc+0x204>
    ...
    panic("runcmd");
      ...
      e4:	26050513          	addi	a0,a0,608 # 1340 <malloc+0x10c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24658593          	addi	a1,a1,582 # 1348 <malloc+0x114>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	20a58593          	addi	a1,a1,522 # 1358 <malloc+0x124>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	18450513          	addi	a0,a0,388 # 1368 <malloc+0x134>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	decb8b93          	addi	s7,s7,-532 # 1390 <malloc+0x15c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	dba50513          	addi	a0,a0,-582 # 1370 <malloc+0x13c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cfa60613          	addi	a2,a2,-774 # 1398 <malloc+0x164>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	ceab0b13          	addi	s6,s6,-790 # 13b8 <malloc+0x184>
  ...
  return ret;
     ...
     70c:	c9850513          	addi	a0,a0,-872 # 13a0 <malloc+0x16c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c3e50513          	addi	a0,a0,-962 # 13a8 <malloc+0x174>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	c1c60613          	addi	a2,a2,-996 # 13c0 <malloc+0x18c>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	bb4a0a13          	addi	s4,s4,-1100 # 13c8 <malloc+0x194>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	b8660613          	addi	a2,a2,-1146 # 13d0 <malloc+0x19c>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	ae860613          	addi	a2,a2,-1304 # 1398 <malloc+0x164>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	b0860613          	addi	a2,a2,-1272 # 13e8 <malloc+0x1b4>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	ab650513          	addi	a0,a0,-1354 # 13d8 <malloc+0x1a4>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	abe50513          	addi	a0,a0,-1346 # 13f0 <malloc+0x1bc>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	af270713          	addi	a4,a4,-1294 # 1450 <malloc+0x21c>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	91e60613          	addi	a2,a2,-1762 # 1328 <malloc+0xf4>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a56:	94e50513          	addi	a0,a0,-1714 # 13a0 <malloc+0x16c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f2:	34290913          	addi	s2,s2,834 # 1430 <malloc+0x1fc>
        while(*s != 0){
